...
const Doc = () => {
  return (
    <>
      <div className="page-styling mx-5 mb-3">
        ...
        <div className="col my-3">
          <p>
            ...
            Quotation For Services (QFS). Should you have any questions that the
            QFS does not answer, our managers would be pleased to take your call
            and discuss any matters with you.
          </p>
        </div>
        <div className="col my-3">
          <p className="px-5">
            <span className="fw-bold">Part 1</span> – Provides the cost details
            for your services as well as the length, on days, of your audit
          </p>
        </div>
        <div className="col my-3">
          <p className="px-5">
            <span className="fw-bold">Part 2</span> – Provides the scope of the
            audit and site(s) details
          </p>
        </div>
        <div className="col my-3">
          <p>
            Accepting our quotation is a matter of signing at the bottom of Page
            4, in the section Client Acceptance You may scan and email both
            pages to the Accordia office or send by fax, if you prefer
          </p>
        </div>
        <div className="col my-3">
          <p>Next Steps:</p>
        ...
        <div className="col my-3 mt-4">
          <p className="normalTextPdf">
            This proposal is considered confidential property of Accordia Global
            Compliance Group and is intended for the sole use of and is not be
            shared outside of either organization
          </p>
        </div>
      </div>
      <div class="page-styling mx-5 mb-3">
        <div class="row mt-3 QuotationHeadingCustompadding">
          <div class="d-flex customer flex-column col-lg-12 col-12 ps-1 pe-1 mb-3 mx-2">
            <div class="row text-center headingBackground py-1 me-4 ms-0 d-flex justify-content-center align-items-center">
              <h3 class="text-white">QUOTATION</h3>
            </div>
          </div>
        </div>
        ...
        <div class="col my-3 mx-2 pe-2 ps-1">
          <h5 class="fw-600">PART I CLIENT-INFORMATION</h5>
        </div>

        <div class="d-flex customer flex-column col-lg-12 col-12 ps-1 pe-3 my-3">
          <div class="row mx-2">
            <div class="col-3 personalBorder">
              <span class="fw-bold">Company Name:</span>
            </div>
            <div class="col-9 personalBorder">
              <span>ABC Corp</span>
            </div>
          </div>
          ...
          <div class="row mx-2">
            ...
            <div class="col-3 personalBorder">
              <span class="fw-bold">VAT Tax/ No</span>
            </div>
            <div class="col-3 personalBorder">
              <span>VAT123456</span>
            </div>
        ...
        <div class="col mt-3 mx-2 pe-2">
          <h5 class="fw-600">PART II SERVICE-INFORMATION</h5>
        </div>

        <div class="d-flex customer flex-column col-lg-12 col-12 ps-0 pe-1 my-3 ms-2 me-4">
          <div class="row text-center heading-border py-1 me-4 ms-1 d-flex justify-content-center align-items-center">
            <h5 class="fw-600">Service Acquired: Audit</h5>
          </div>
        </div>

        <div class="col my-3 mx-2 pe-2">
          <h5 class="fw-600">PART III SITE-INFORMATION</h5>
        </div>

        <div class="d-flex customer flex-column col-lg-12 col-12 ps-0 pe-3 my-3 mx-1">
          <div class="row mx-2">
            <div class="col-3 personalBorder">
          ...
          <div class="row mx-2">
            <div class="col-3 personalBorder">
              <span class="fw-bold">Site Address:</span>
            </div>
            <div class="col-9 personalBorder">
          ...
          <div class="row mx-2">
            <div class="col-3 personalBorder">
              <span class="fw-bold">Scope Of Certification</span>
            </div>
            <div class="col-9 personalBorder">
              <span>ISO 9001</span>
            </div>
          ...
          <div class="row mx-2">
            ...
            <div class="col-3 personalBorder">
              <span class="fw-bold">No of Shifts</span>
            </div>
            <div class="col-3 personalBorder">
              <span>2</span>
            </div>
          ...
          <div class="row mx-2">
            <div class="col-3 personalBorder">
              <span class="fw-bold">Primary Process</span>
            </div>
            <div class="col-9 personalBorder">
          ...
          <div class="row mx-2">
            <div class="col-3 personalBorder">
              <span class="fw-bold">Secondary Process</span>
            </div>
            <div class="col-9 personalBorder">
              <span>Packaging</span>
            </div>
          ...
          <div class="row mx-2">
            <div class="col-3 personalBorder">
              <span class="fw-bold">Facility Size</span>
            </div>
            <div class="col-3 personalBorder">
              <span>5000 sq ft</span>
            </div>
            <div class="col-3 personalBorder">
              <span class="fw-bold">Facility Covered Area</span>
            </div>
            <div class="col-3 personalBorder">
          ...
          <div class="row mx-2">
            <div class="col-3 personalBorder">
              <span class="fw-bold">Representative Contact No</span>
            </div>
            <div class="col-3 personalBorder">
              <span>+0987654321</span>
            </div>
            <div class="col-3 personalBorder">
              <span class="fw-bold">Representative Email</span>
            </div>
            <div class="col-3 personalBorder">
      ...
      <div class="page-styling mx-5 mb-3">
        <div class="col my-3 mx-2 pe-2">
          <h5 class="fw-600">PART IV COST</h5>
        </div>
        <div class="col my-3 mx-2 pe-2">
          <h5 class="fw-600">
        ...
        <div class="d-flex customer flex-column col-lg-12 col-12 ps-0 pe-3 my-3 personalPaddingClass">
          <div class="row mx-1 d-flex justify-content-center">
            <div class="col-6 personalBorder text-center headingBackground">
              <span class="fw-bold">Fee (Descriptions)</span>
            </div>
            <div class="col-2 personalBorder text-center headingBackground">
              <span class="fw-bold">Audit Days</span>
            </div>
            <div class="col-2 personalBorder text-center headingBackground">
              <span class="fw-bold">Rate</span>
            </div>
            <div class="col-2 personalBorder text-center headingBackground">
              <span class="fw-bold">Audit Fee</span>
            </div>
          </div>

          <div class="row mx-1 d-flex justify-content-center">
            <div class="col-6 personalBorder text-center">
              <span>Fee Name 1</span>
            </div>
            <div class="col-2 personalBorder text-center">
              <span>5</span>
            </div>
            <div class="col-2 personalBorder text-center">
              <span>USD 100</span>
          ...
          <div class="row mx-1 d-flex justify-content-center">
            <div class="col-4 text-end personalBorderwithoutRight">
              <span class="fw-bold"></span>
            </div>
            <div class="col-2 text-end personalBorderwithoutx">
              <span class="fw-bold"></span>
            </div>
            <div class="col-2 text-end personalBorderwithoutx">
              <span class="fw-bold"></span>
            </div>
            <div class="col-2 text-end personalBorderwithoutLeft">
              <span class="fw-bold">Total Amount</span>
            </div>
            <div class="col-2 text-center personalBorder">
              <span class="fw-bold">USD 950</span>
            </div>
          </div>
          ...
          <div class="row mx-1 d-flex justify-content-center">
            ...
            <div class="col-2 text-end personalBorderwithoutLeft">
              <span class="fw-bold">Applicable Taxes</span>
            </div>
            <div class="col-2 text-center personalBorder">
              <span class="fw-bold">USD 50</span>
            </div>
          </div>
          ...
          <div class="row mx-1 d-flex justify-content-center">
            ...
            <div class="col-2 text-end personalBorderwithoutLeft">
              <span class="fw-bold">Total Amount (After Tax)</span>
            </div>
            <div class="col-2 text-center personalBorder">
              <span class="fw-bold">USD 1000</span>
            </div>
          </div>
        </div>

        <div class="col my-3 mx-2 pe-2">
          <h5 class="fw-600">Fees And Payments</h5>
        </div>
        <div class="row my-3">
          <div class="col mx-4">
            <ol type="a">
              ...
              <li>
                Client shall pay all collection costs, including attorney’s fees
                and related costs.
              </li>
              <li>
              ...
              <li>
                ...
                outside control, payment of non-refundable expenses and fees may
                still be required.
              </li>
            </ol>
          </div>
      ...
      <div class="page-styling mx-5 mb-3">
        ...
        <h5 class="fw-600">WRAP</h5>
        <div class="d-flex customer flex-column col-lg-12 col-12 ps-0 pe-3 my-3">
          <div class="row mx-2 headingBackground">
            <div class="col-6 personalBorder text-center">
              <span class="fw-bold">No Of Workers</span>
            </div>
            <div class="col-6 personalBorder text-center">
              <span class="fw-bold">Audit Days</span>
            </div>
        ...
        <h5 class="fw-600">HIGG INDEX FEM 4.0 VERIFICATION</h5>
        <div class="d-flex customer flex-column col-lg-12 col-12 ps-0 pe-3 my-3">
          <div class="row mx-2 headingBackground">
            <div class="col-4 personalBorder text-center">
              <span class="fw-bold">Production Process</span>
            </div>
            <div class="col-4 personalBorder text-center">
              <span class="fw-bold">Number Of Employee</span>
            </div>
            <div class="col-4 personalBorder text-center">
              <span class="fw-bold">No of Audit Days</span>
            </div>
          </div>
          <div class="row mx-2">
            <div class="col-4 personalBorder text-center">
        ...
        <h5 class="fw-600">SMETA</h5>
        <div class="d-flex customer flex-column col-lg-12 col-12 ps-0 pe-3 my-3">
          <div class="row mx-2 headingBackground">
            <div class="col-4 personalBorder text-center">
              <span class="fw-bold">Column 1</span>
            </div>
            <div class="col-4 personalBorder text-center">
              <span class="fw-bold">Audit Days</span>
            </div>
            <div class="col-4 personalBorder text-center">
              <span class="fw-bold">Column 3</span>
            </div>
          </div>
          <div class="row mx-2">
            <div class="col-4 personalBorder text-center">
        ...
        <div class="col my-3 mx-2 pe-2">
          <h5 class="fw-600">Notes</h5>
        </div>
        <div class="row my-3 mx-4">
          <div class="col py-1">
            <p class="normalTextPdf">
        ...
        <div class="col my-3 mx-2 pe-2">
          <h5 class="fw-600">PART VI - ACCEPTANCE OF QUOTATION AND TERMS</h5>
        </div>
        <div class="row my-3 mx-4">
          <div class="col py-1">
            <p class="my-4">
              Accordia Certification Rules and Integrity Policy are all found on
              Accordia’s website at www.Accordiausa.com and combined with this
              Quotation all shall form the agreement between you (the Client)
              and Accordia Global Compliance Group entity (Accordia) providing
              the services. Clients engaging Accordia for third party
              certification services (e.g. SA8000 Certification) further agrees
              to Accordia Certification Rules found on the Accordia website
              www.accordiausa.com. IN WITNESS WHEREOF, Accordia and Client
              hereto have executed this Agreement as of the date written below.
            </p>
            <h5 class="fw-600">Client Company Name</h5>
          </div>
        </div>
        <div class="row mb-3 mx-4 mt-5">
          <div class="col py-1 fw-bold">
            Sign:{" "}
            <span class="ps-2 ms-5">
